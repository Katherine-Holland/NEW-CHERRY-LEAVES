...
def page_cherryleaves_visualizer_body():
    ...
    st.info(
        ...
        "**Key Insights:**\n"
        "- Visual analysis of leaf images to "
    ...
    if st.checkbox("📊 Difference Between Average and Variability Images"):
        ...
        st.warning(
            "### Observations:\n"
            "- The average and variability images "
            "did **not** exhibit strong patterns "
            "to intuitively distinguish healthy from infected leaves.\n"
            "- However, a **subtle difference** "
            "in color pigmentation can be seen between "
    ...
    if st.checkbox(
        ...
        st.warning(
            ...
            "- More advanced feature extraction methods may be required"
            " to find meaningful visual distinctions.\n"
        )
        st.image(
